...
class GazeboCircuit2cTurtlebotCameraCnnEnv(gazebo_env.GazeboEnv):

    def __init__(self):
        # Launch the simulation with the given launchfile name
        gazebo_env.GazeboEnv.__init__(self, "GazeboCircuit2cTurtlebotLidar_v0.1.launch")
    ...
    def step(self, action):
        ...
        state = cv_image.reshape(1, cv_image.shape[0], cv_image.shape[1], cv_image.shape[2])
